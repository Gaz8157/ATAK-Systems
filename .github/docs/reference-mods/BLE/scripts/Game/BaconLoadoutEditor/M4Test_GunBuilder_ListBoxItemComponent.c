...
sealed class Bacon_GunBuilderUI_ListBoxFocusComponent: SCR_ListBoxComponent
{
...
sealed class Bacon_GunBuilderUI_ListBoxElementComponent : SCR_ListBoxElementComponent
{
	[Attribute("Preview")]
