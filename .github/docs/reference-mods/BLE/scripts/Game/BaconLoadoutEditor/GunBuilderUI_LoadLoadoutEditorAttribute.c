...
sealed class Bacon_GunBuilder_ApplyLoadoutEditorAttribute : SCR_BaseFloatValueHolderEditorAttribute
{	
...
sealed class Bacon_GunBuilder_ApplyLoadoutEditorAttributeDescription : SCR_BaseAttributeDynamicDescription
{
	//------------------------------------------------------------------------------------------------
